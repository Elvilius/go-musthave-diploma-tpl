...
// Package mocks_users is a generated GoMock package.
package mocks_users
...
func (m *MockStorer) CreateUser(ctx context.Context, login, passwordHash string) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) CreateUser(ctx, login, passwordHash interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateUser", reflect.TypeOf((*MockStorer)(nil).CreateUser), ctx, login, passwordHash)
}

// GetUserByLogin mocks base method.
func (m *MockStorer) GetUserByLogin(ctx context.Context, login string) (models.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) GetUserByLogin(ctx, login interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByLogin", reflect.TypeOf((*MockStorer)(nil).GetUserByLogin), ctx, login)
}
